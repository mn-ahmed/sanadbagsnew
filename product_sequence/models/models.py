    ...
    def _name_search(self, name, args=None, operator='ilike', limit=100, name_get_uid=None):
        ...
        if name:
            ...
            if operator in positive_operators:
                product_ids = self._search(['|',('default_code', '=', name), ('item_code', 'ilike', name)] + args, limit=limit,
                                           access_rights_uid=name_get_uid)
                if not product_ids:
                    product_ids = self._search(['|',('barcode', '=', name), ('item_code', 'ilike', name)] + args, limit=limit,
                                               access_rights_uid=name_get_uid)
